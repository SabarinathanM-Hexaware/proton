...
using ElmahCore.Mvc;
using ElmahCore;
using proto.Api.Filters;
using proto.Business.Installer;

namespace proto.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "proto API", Version = version + "-" + branch});
            });
